 ...
 * @property players Hash map of the players. Key: Color of player; Value: Player
 * @property playerWhite Player reference for color white. (Only necessary for database deletion)
 * @property playerBlack Player reference for color black. (Only necessary for database deletion)
