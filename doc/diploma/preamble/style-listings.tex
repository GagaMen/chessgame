\IfDefined{colorlet}{
   \colorlet{colorlstNumber}{white!25!black!100}
   \colorlet{colorlstBackground}{white!95!black!100}
}
...
%%%  Space and placement
   ,floatplacement=htbp    % is used as float place specifier
...
%%% Line numbers
   ...
   ,numberstyle=\scriptsize\color{colorlstNumber}    % style of numbers
...
%%% Margins and line shape
   ...
   ,xleftmargin=10pt      % extra margins
   ,xrightmargin=0pt     %
   ...
   ,columns=flexible     %
   ,keepspaces=true      %
   ,backgroundcolor=\color{colorlstBackground}
...
%%% Frames
   ,frame=lines         % none, leftline, topline, bottomline, lines
                         % single, shadowbox
   ,framesep=3pt 
...
\input{preamble/listings-kotlin.tex}
\input{preamble/listings-groovy.tex}
\input{preamble/listings-javascript.tex}
\input{preamble/listings-html5.tex}
