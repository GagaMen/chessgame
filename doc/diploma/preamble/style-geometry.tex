...
%%% Margin
   left=4cm,        % left margin (for oneside) or inner margin (for twoside) of total body
                  % alias: lmargin, inner
...
%%% Dimensionen
   ...
   headsep=1.25cm,     % separation between header and text
   footskip=1.25cm,    % distance separation between baseline of last line of text and baseline of footer
                  % Alias: foot
