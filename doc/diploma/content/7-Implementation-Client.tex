...
\\
Um die Bibliothek in einem Projekt, mit Gradle als Build Tool zu verwenden, müssen die Zeilen aus \hyperref[lst:includeKotlinxHtml]{Listing~\ref{lst:includeKotlinxHtml}} in die Datei \code{build.gradle} eingefügt werden.
