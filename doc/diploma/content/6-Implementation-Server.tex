...
\\
Um Spring in einem Projekt einzubinden, müssen die Zeilen aus dem \hyperref[lst:includeSpring]{Listing~\ref{lst:includeSpring}}, zusätzlich zu denen welche Kotlin benötigt\todo{ggf. irgendwo beschreiben wie man Kotlin in Gradle einbindet}, in der Build-Datei \code{build.gradle} eingefügt werden.
