...
\\
Da für diese Arbeit die Benutzung der Programmiersprache Kotlin vorgegeben ist, wird auf eine Benotung der Vergleichsteilnehmer verzichtet. Dennoch kann das Vergleichsergebnis dazu genutzt werden den Entscheidungsprozess für geplante Projekte zu beschleunigen. Dafür sollte im Vorfeld jedes Kriterium gewichtet werden, um so eine individuelle und präzise Benotung zu ermöglichen.
...
\subsubsection{Beliebtheit}
\begin{description}
	\item[Kotlin] Laut Github existieren derzeit über 72~590\footnote{siehe \url{https://api.github.com/search/repositories?q=language:Kotlin} (besucht am 14.06.2018)} Repositories, welche mit Kotlin entwickelt wurden bzw. noch werden. Die Zahl der auf Stack Overflow gestellten Fragen beläuft sich auf 11~398\footnote{siehe \url{https://stackoverflow.com/questions/tagged/kotlin} (besucht am 14.06.2018)}. (Stand: 14.06.2018)
	\item[GWT(Java)] Die Anzahl der Github-Repositories beträgt derzeit 4~810~228\footnote{siehe \url{https://api.github.com/search/repositories?q=language:Java} (besucht am 14.06.2018)} für Java-Projekte. Da \gls{GWT} ein Framework ist, lässt sich über Github keine verwertbare Zahl ermitteln, wie viele Repositories dieses benutzen. Bei den gestellten Fragen auf Stack Overflow sieht das anders aus, denn derzeit sind 1~426~726\footnote{siehe \url{https://stackoverflow.com/questions/tagged/java} (besucht am 14.06.2018)} mit Java und 20~443\footnote{siehe \url{https://stackoverflow.com/questions/tagged/gwt} (besucht am 14.06.2018)} mit \gls{GWT} getaggt. (Stand: 14.06.2018)
\end{description}
