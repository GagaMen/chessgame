...
\IfPackagesLoaded{glossaries,longtable,tabu}{%
  \clearpage\IfDefined{phantomsection}{\phantomsection}\label{sec:loa}
  % print out acronym list   
  \IfGlossariesStyleDefined{longtabuFancyHeader}%
   {\addcontentsline{toc}{chapter}{Abkürzungsverzeichnis}\printglossary[type=\acronymtype,style=longtabuFancyHeader, title={Abkürzungsverzeichnis}]}%
...
\IfDefined{lstlistoflistings}{\cleardoublepage\IfDefined{phantomsection}{\phantomsection}\label{sec:lol}\addcontentsline{toc}{chapter}{Listings}\lstlistoflistings}
...
\include{content/2-Basics}
\include{content/3-Comparison-Kotlin-GWT}
\include{content/4-Konception-Server}
\include{content/5-Konception-Client}
\include{content/6-Implementation-Server}
\include{content/7-Implementation-Client}
\include{content/8-Conclusion}
\include{content/9-Outlook}
