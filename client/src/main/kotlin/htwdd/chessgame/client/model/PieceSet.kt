    ...
    private fun setStartPieces() {
        when (pieceColor) {
            PieceColor.WHITE -> {
                ...
                activePieces[Pair(1, 3)] = Piece(PieceType.BISCHOP, Field(1, 3))
                activePieces[Pair(1, 4)] = Piece(PieceType.QUEEN, Field(1, 4))
                activePieces[Pair(1, 5)] = Piece(PieceType.KING, Field(1, 5))
                activePieces[Pair(1, 6)] = Piece(PieceType.BISCHOP, Field(1, 6))
            ...
            PieceColor.BLACK -> {
                ...
                activePieces[Pair(8, 3)] = Piece(PieceType.BISCHOP, Field(8, 3))
                activePieces[Pair(8, 4)] = Piece(PieceType.QUEEN, Field(8, 4))
                activePieces[Pair(8, 5)] = Piece(PieceType.KING, Field(8, 5))
                activePieces[Pair(8, 6)] = Piece(PieceType.BISCHOP, Field(8, 6))
